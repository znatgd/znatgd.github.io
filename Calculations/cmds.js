function add() {
    var num1 = parseInt(prompt("Enter first number: ", "13")); //Input answer and converts from string to int
    var num2 = parseInt(prompt("Enter the second number: ", "25")); //Input answer and converts from string to int
